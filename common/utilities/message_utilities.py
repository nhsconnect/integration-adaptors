...
class MessageUtilities(object):
    ...
    def load_test_data(message_dir, filename_without_extension):
        message = file_utilities.FileUtilities.get_file_string(message_dir / (filename_without_extension + ".msg"))
        ebxml = file_utilities.FileUtilities.get_file_string(message_dir / (filename_without_extension + ".ebxml"))
