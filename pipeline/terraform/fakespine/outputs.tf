...
output "fake_spine_lb_domain_name" {
  value = aws_route53_record.fake_spine_load_balancer_record.name
  description = "The DNS name of the Route53 record pointing to the fake spine service's load balancer."
}