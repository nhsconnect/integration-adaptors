...
class TestAsynchronousReliableWorkflow(unittest.TestCase):
    def setUp(self):
        ...
        self.workflow = async_reliable.AsynchronousReliableWorkflow(party_key=PARTY_KEY,
    ...
    async def test_handle_outbound_message(self, log_mock):
        ...
        self.mock_ebxml_request_envelope.return_value.serialize.return_value = (MESSAGE_ID, HTTP_HEADERS,
                                                                                SERIALIZED_MESSAGE)
