...
* `MHS_RESYNC_TIMEOUT` The total time to wait for a sync-async response to be placed on the sync-async store
* `MHS_RESYNC_INTERVAL` The time inbetween polls of the sync-async store 
