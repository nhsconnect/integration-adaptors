...
class TestSyncAsyncWorkflow(TestCase):
    ...
    def test_prepare_message_async(self, mock_get_uuid, mock_envelope):
        ...
        expected_context = {
            ...
            ebxml_envelope.CONVERSATION_ID: fixed_uuid,
        ...
        mock_envelope_instance.serialize.return_value = sentinel.ebxml_id, sentinel.ebxml_message
        ...
        self.assertTrue(mock_envelope_instance.serialize.called)
