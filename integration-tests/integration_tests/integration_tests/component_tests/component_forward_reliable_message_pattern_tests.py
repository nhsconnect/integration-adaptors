...
class ForwardReliablesMessagingPatternTests(unittest.TestCase):
    ...
    def test_should_return_information_from_soap_fault_returned_by_spine_in_original_post_request_to_client_when_sync_async_requested(self):
        """
    ...
    def test_should_record_message_status_when_soap_fault_returned_from_spine_and_sync_async_requested(self):
        """
                Message ID: AD7D39A8-1B6C-4520-8367-6B7BEBD7B842 configured in fakespine to return a SOAP Fault error.
                Error found here: fake_spine/fake_spine/configured_responses/soap_fault_single_error.xml
                """
    ...
    def test_should_return_information_from_ebxml_fault_returned_by_spine_in_original_post_request_to_client_when_sync_async_requested(self):
        """
        Message ID: 'A7D43B03-38FB-4ED7-8D04-0496DBDEDB7D' configured in fakespine to return a ebxml fault
        """
    ...
    def test_should_record_message_status_when_ebxml_fault_returned_from_spine_and_sync_async_requested(self):
        """
        Message ID: 'A7D43B03-38FB-4ED7-8D04-0496DBDEDB7D' configured in fakespine to return a ebxml fault
        """
