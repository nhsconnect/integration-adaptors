...
class FunctionalTest(TestCase):
    ...
    def test_mhs_async_express_outbound_status(self):
    ...
    def test_mhs_async_express_inbound_message_id(self):
        # send the message
    ...
    def test_mhs_async_express_inbound_correlation_id(self):
        # send the message
    ...
    def test_mhs_async_express_inbound_response(self):
        # send the message
