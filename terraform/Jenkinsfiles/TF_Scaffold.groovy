...
Map <String, Map<String, String>> componentImageBranch = [
  ...
  "gpc-consumer":     [ecrRepo: "gpc-consumer",          branch: "main"]
]
...
pipeline {
  ...
  parameters {
    ...
    choice (name: "Component",   choices: ['base', 'nhais', 'OneOneOne', 'mhs', 'account', 'fake_mesh', 'nhais_responder', 'gp2gp', 'lab-results', 'gpc-consumer'],     description: "Choose component")
