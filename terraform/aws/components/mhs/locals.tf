locals {
  ...
  inbound_logs_prefix = var.mhs_inbound_alternative_image_tag  == "" ? var.mhs_build_id : replace(var.mhs_inbound_alternative_image_tag,"/","-")
  outbound_logs_prefix = var.mhs_outbound_alternative_image_tag  == "" ? var.mhs_build_id : replace(var.mhs_outbound_alternative_image_tag,"/","-")
  route_logs_prefix = var.mhs_route_alternative_image_tag  == "" ? var.mhs_build_id : replace(var.mhs_route_alternative_image_tag,"/","-")
