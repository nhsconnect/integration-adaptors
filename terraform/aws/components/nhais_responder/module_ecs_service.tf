module "nhais_responder_ecs_service" {
  ...
  region          = var.region
  module_instance = "nhais_responder_ecs"
  ...
  minimal_count     = var.nhais_responder_service_minimal_count
  desired_count     = var.nhais_responder_service_desired_count
  maximal_count     = var.nhais_responder_service_maximal_count
  service_target_request_count = var.nhais_responder_service_target_request_count

  container_port    = var.nhais_responder_service_container_port
  application_port  = var.nhais_responder_service_application_port
  launch_type       = var.nhais_responder_service_launch_type
  log_stream_prefix = var.nhais_responder_build_id
  healthcheck_path  = var.nhais_healthcheck_path
  enable_load_balancing = true

  container_healthcheck_port = var.nhais_responder_service_container_port
  ...
  additional_security_groups = [
    ...
    aws_security_group.nhais_responder_external_access.id
  ]
