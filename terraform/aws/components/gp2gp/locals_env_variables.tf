locals {
  environment_variables = concat(var.gp2gp_environment_variables, [
    ...
    },
    {
      ...
      value = var.gp2gp_create_gpcc_mock ? "http://${module.gpcc_mock_ecs_service.loadbalancer_dns_name}:${var.gp2gp_mock_port}/GP0001/STU3/1/gpconnect" : "http://${module.gpc-consumer_ecs_service.loadbalancer_dns_name}:${var.gpc-consumer_service_container_port}/B82617/STU3/1/gpconnect"
    },
    {
