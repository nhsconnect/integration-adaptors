# module "gpc-consumer_wiremock_ecs_service" {
#   source = "../../modules/module_ecs_service"
  
#   count           = var.gpc-consumer_create_wiremock ? 1 : 0
#   project         = var.project
#   component       = var.component
#   environment     = var.environment
#   region          = var.region
#   module_instance = "gpc-consumer_wiremock_ecs"
#   default_tags    = local.gpc-consumer_default_tags

#   availability_zones = local.availability_zones

#   image_name        = local.gpc-consumer_wiremock_image_name
#   cluster_id        = data.terraform_remote_state.base.outputs.base_cluster_id
#   minimal_count     = var.gpc-consumer_service_minimal_count
#   desired_count     = var.gpc-consumer_service_desired_count
#   maximal_count     = var.gpc-consumer_service_maximal_count
#   service_target_request_count = var.gpc-consumer_service_target_request_count

#   container_port    = var.gpc-consumer_wiremock_container_port 
#   application_port  = var.gpc-consumer_wiremock_application_port 
#   launch_type       = var.gpc-consumer_service_launch_type
#   log_stream_prefix = var.gpc-consumer_build_id
...
#   container_healthcheck_port = var.gpc-consumer_wiremock_container_port
