module "gpc-consumer_ecs_service" {
  ...
  image_name        = local.gpc-consumer_image_name
  ...
  container_port    = var.gpc-consumer_service_container_port
  application_port  = var.gpc-consumer_service_application_port
