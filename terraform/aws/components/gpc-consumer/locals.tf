locals {
  ...
  image_name = "${var.account_id}.dkr.ecr.${var.region}.amazonaws.com/gpc-consumer:${var.gpc-consumer_build_id}"
  wiremock_image_name = "${var.account_id}.dkr.ecr.${var.region}.amazonaws.com/gpc-consumer-wiremock:${var.gpc-consumer_build_id}"
