                    ...
                    steps {
                        dir('pipeline/terraform/mhs-environment') {
                            ...
                            sh label: 'Applying Terraform configuration', script: """
                                    ...
                                    export TF_VAR_build_id=${BUILD_TAG}
                                    export TF_VAR_supplier_vpc_id=${SUPPLIER_VPC_ID}
                                    export TF_VAR_opentest_vpc_id=${OPENTEST_VPC_ID}
                                    export TF_VAR_internal_root_domain=${INTERNAL_ROOT_DOMAIN}
                                    export TF_VAR_mhs_outbound_service_minimum_instance_count=3
                                    export TF_VAR_mhs_outbound_service_maximum_instance_count=9
                                    export TF_VAR_mhs_inbound_service_minimum_instance_count=3
                                    export TF_VAR_mhs_inbound_service_maximum_instance_count=9
                                    export TF_VAR_mhs_route_service_minimum_instance_count=3
                                    export TF_VAR_mhs_route_service_maximum_instance_count=9
                                    export TF_VAR_task_role_arn=${TASK_ROLE}
                                    export TF_VAR_execution_role_arn=${TASK_EXECUTION_ROLE}
                                    export TF_VAR_task_scaling_role_arn=${TASK_SCALING_ROLE}
                                    export TF_VAR_ecr_address=${DOCKER_REGISTRY}
                                    export TF_VAR_mhs_log_level=DEBUG
                                    export TF_VAR_mhs_outbound_http_proxy=${MHS_OUTBOUND_HTTP_PROXY}
                                    export TF_VAR_mhs_state_table_read_capacity=5
                                    export TF_VAR_mhs_state_table_write_capacity=5
                                    export TF_VAR_mhs_sync_async_table_read_capacity=5
                                    export TF_VAR_mhs_sync_async_table_write_capacity=5
                                    export TF_VAR_mhs_spine_org_code=${SPINE_ORG_CODE}
                                    export TF_VAR_inbound_queue_host="${MHS_INBOUND_QUEUE_URL}/${MHS_INBOUND_QUEUE_NAME}"
                                    export TF_VAR_inbound_queue_username_arn=${INBOUND_QUEUE_USERNAME_ARN}
                                    export TF_VAR_inbound_queue_password_arn=${INBOUND_QUEUE_PASSWORD_ARN}
                                    export TF_VAR_party_key_arn=${PARTY_KEY_ARN}
                                    export TF_VAR_client_cert_arn=${CLIENT_CERT_ARN}
                                    export TF_VAR_client_key_arn=${CLIENT_KEY_ARN}
                                    export TF_VAR_ca_certs_arn=${CA_CERTS_ARN}
                                    export TF_VAR_route_ca_certs_arn=${ROUTE_CA_CERTS_ARN}
                                    export TF_VAR_outbound_alb_certificate_arn=${OUTBOUND_ALB_CERT_ARN}
                                    export TF_VAR_route_alb_certificate_arn=${ROUTE_ALB_CERT_ARN}
                                    export TF_VAR_mhs_resynchroniser_max_retries=${MHS_RESYNC_RETRIES}
                                    export TF_VAR_mhs_resynchroniser_interval=${MHS_RESYNC_INTERVAL}
                                    export TF_VAR_spineroutelookup_service_sds_url=${SPINEROUTELOOKUP_SERVICE_LDAP_URL}
                                    export TF_VAR_spineroutelookup_service_search_base=${SPINEROUTELOOKUP_SERVICE_SEARCH_BASE}
                                    export TF_VAR_spineroutelookup_service_disable_sds_tls=${SPINEROUTELOOKUP_SERVICE_DISABLE_TLS}
                                    export TF_VAR_elasticache_node_type="cache.t2.micro"
                                    export TF_VAR_mhs_forward_reliable_endpoint_url=${MHS_FORWARD_RELIABLE_ENDPOINT_URL}
