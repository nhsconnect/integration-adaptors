...
class TestHttpTransport(TestCase):
    ...
    def setUp(self):
        self.transport = HttpTransport(CERTS_DIR)
    ...
    def test_make_request(self, mock_post):
        ...
        actual_response = self.transport.make_request(interaction_details, MESSAGE)
    ...
    def test_build_headers(self):
        actual_headers = HttpTransport._build_headers({
            TYPE_NAME: TYPE_VALUE,
            CONTENT_TYPE_NAME: CONTENT_TYPE_VALUE,
            CHARSET_NAME: CHARSET_VALUE,
            SOAP_ACTION_NAME: SOAP_ACTION_VALUE,
    ...
    def test_get_request_method(self):
        ...
        for http_method in supported_http_methods:
            with self.subTest(http_method=http_method):
                ...
                actual_request_method = HttpTransport._get_request_method({"request_type": http_method})
